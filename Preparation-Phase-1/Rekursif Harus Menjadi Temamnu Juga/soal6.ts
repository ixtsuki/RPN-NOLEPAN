...
function palindromeRecursive(sentence: string) {
  ...
  switch(sentence.length) {
    ...
    default:
      ...
      const secondLetter = sentence[sentence.length-1];
      return firstLetter === secondLetter ? palindromeRecursive(sentence.slice(1, -1)) : false;
  }
}
